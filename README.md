Sweet Crush
Simulación del juego Sweet Crush desarrollada en C++ para la asignatura Informática II.
El objetivo principal es la representación de un tablero de dimensiones variables con optimización de memoria RAM
, almacenando cada casilla en exactamente 3 bits mediante operaciones de bits.
